			...
			__all__: {
				...
				__init__: function (__all__) {
					...
					var _local_time_tuple = function (jd) {
						var res = tuple ([jd.getFullYear (), jd.getMonth () + 1, jd.getDate (), jd.getHours (), jd.getMinutes (), jd.getSeconds (), jd.getDay () - 1, _day_of_year (jd, true), _daylight (jd), jd.getMilliseconds ()]);
						return res;
					};
					...
					var altzone = __now.getTimezoneOffset () * 60;
